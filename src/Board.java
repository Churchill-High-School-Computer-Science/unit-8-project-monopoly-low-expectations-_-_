...
public class Board {
    ...
    public Board() {
        ...
        properties[10][10] = new Property(new Color(205, 230, 208), "Go", "0", 0, 0);
        ...
        properties[10][0] = new Property(new Color(205, 230, 208), "Go to Jail", "0", 0, 0);
        ...
        properties[0][0] = new Property(new Color(205, 230, 208), "Free Parking", "0", 0, 0);
        ...
        properties[0][10] = new Property(new Color(205, 230, 208), "Jail", "0", 0, 0);
        ...
        properties[3][10] = new Property(new Color(205, 230, 208), "Chance", "0", 0, 0);
        ...
        properties[6][10] = new Property(new Color(205, 230, 208), "Income Tax", "0", 0, 0);
        properties[7][10] = new Property(new Color(139,87,59), "Baltic Avenue", "60", 30, 33);
        properties[8][10] = new Property(new Color(205, 230, 208), "Community Chest", "0", 0, 0);
